...
QJsonObject TgBigData::getImportAttributes() const { return m_importAttributes; }
void TgBigData::setImportAttributes(const QJsonObject& attrs) { m_importAttributes = attrs; }
