...
#ifndef CHROMATOGRAPHDIFFERENCEWORKBENCH_H
#define CHROMATOGRAPHDIFFERENCEWORKBENCH_H
...
class ChromatographDifferenceWorkbench : public QMdiSubWindow
{
    Q_OBJECT
public:
    // 构造函数接收"参考曲线"和"所有对比曲线"
    explicit ChromatographDifferenceWorkbench(int referenceSampleId,
                                 const BatchGroupData& allProcessedData,
                                 AppInitializer* appInit,
                                 const ProcessingParameters& params,
                                 QWidget* parent = nullptr);
    // ChromatographDifferenceWorkbench(QSharedPointer<Curve> referenceCurve,
...
signals:
    void closed(ChromatographDifferenceWorkbench* self);
...
#endif // CHROMATOGRAPHDIFFERENCEWORKBENCH_H
