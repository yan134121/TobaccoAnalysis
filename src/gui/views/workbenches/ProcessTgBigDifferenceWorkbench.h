...
#ifndef PROCESSTGBIGDIFFERENCEWORKBENCH_H
#define PROCESSTGBIGDIFFERENCEWORKBENCH_H
...
class ProcessTgBigDifferenceWorkbench : public QMdiSubWindow
{
    Q_OBJECT
public:
    // 构造函数接收"参考曲线"和"所有对比曲线"
    explicit ProcessTgBigDifferenceWorkbench(int referenceSampleId,
                                 const BatchGroupData& allProcessedData,
                                 AppInitializer* appInit,
                                 const ProcessingParameters& params,
                                 QWidget* parent = nullptr);
    // ProcessTgBigDifferenceWorkbench(QSharedPointer<Curve> referenceCurve,
...
signals:
    void closed(ProcessTgBigDifferenceWorkbench* self);
...
private:
    ...
    // 导出“工序-大热重工艺内差异度详细表”
    void exportProcessIntraDifferenceDetailTable();
...
#endif // PROCESSTGBIGDIFFERENCEWORKBENCH_H
