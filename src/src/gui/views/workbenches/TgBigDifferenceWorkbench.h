...
#ifndef TGBIGDIFFERENCEWORKBENCH_H
#define TGBIGDIFFERENCEWORKBENCH_H
...
class TgBigDifferenceWorkbench : public QMdiSubWindow
{
    Q_OBJECT
public:
    // 构造函数接收"参考曲线"和"所有对比曲线"
    explicit TgBigDifferenceWorkbench(int referenceSampleId,
                                 const BatchGroupData& allProcessedData,
                                 AppInitializer* appInit,
                                 const ProcessingParameters& params,
                                 QWidget* parent = nullptr);
    // TgBigDifferenceWorkbench(QSharedPointer<Curve> referenceCurve,
...
signals:
    void closed(TgBigDifferenceWorkbench* self);
...
#endif // TGBIGDIFFERENCEWORKBENCH_H
